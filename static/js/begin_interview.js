...
function startListening(output_field,start_button,stop_button,audiogif) {
    ...
    const chunks = [];
    document.getElementById(output_field).innerHTML = "Listening...";
      ...
      mediaRecorder.onstop = function () {
        ...
        xhr.onreadystatechange = function () {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            document.getElementById(output_field).innerHTML = data['result'];
          }
        };
        xhr.send(formData);
      };
...
function stopListening(output_field,start_button,stop_button,audiogif) {
  ...
  document.getElementById(output_field).innerHTML = "Please wait we are processing your answer...";
